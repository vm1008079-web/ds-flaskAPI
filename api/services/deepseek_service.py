...
# Añadir el directorio raíz al path para importar deepseekcli
ROOT_DIR = Path(__file__).parent.parent.parent  # sube hasta la raíz del repo
    ...
    def send_message(
        ...
        def chat_thread():
            try:
                ...
                # Al finalizar, enviar evento done con el ID del mensaje
